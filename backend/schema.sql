-- HatimConnect Database Schema
-- Run this script to create the database tables

CREATE DATABASE IF NOT EXISTS hatimconnect;
USE hatimconnect;
...
CREATE TABLE IF NOT EXISTS juz_assignments (
  ...
  hatim_id INT NOT NULL,
  user_id INT NULL,
  juz_number TINYINT NOT NULL CHECK (juz_number BETWEEN 1 AND 30),
...
-- Reading progress (for individual tracking)
